...
*/
//undefined
import ts, { MapLike, SortedReadonlyArray, SortedArray, Path, TextRange, ReadonlyTextRange, SyntaxKind, TriviaSyntaxKind, LiteralSyntaxKind, PseudoLiteralSyntaxKind, PunctuationSyntaxKind, KeywordSyntaxKind, ModifierSyntaxKind, KeywordTypeSyntaxKind, TokenSyntaxKind, JsxTokenSyntaxKind, JSDocSyntaxKind, NodeFlags, ModifierFlags, JsxFlags, Node, JSDocContainer, LocalsContainer, FlowContainer, HasJSDoc, HasType, HasTypeArguments, HasInitializer, HasExpressionInitializer, HasDecorators, HasModifiers, NodeArray, Token, EndOfFileToken, PunctuationToken, DotToken, DotDotDotToken, QuestionToken, ExclamationToken, ColonToken, EqualsToken, AmpersandAmpersandEqualsToken, BarBarEqualsToken, QuestionQuestionEqualsToken, AsteriskToken, EqualsGreaterThanToken, PlusToken, MinusToken, QuestionDotToken, KeywordToken, AssertsKeyword, AssertKeyword, AwaitKeyword, CaseKeyword, ModifierToken, AbstractKeyword, AccessorKeyword, AsyncKeyword, ConstKeyword, DeclareKeyword, DefaultKeyword, ExportKeyword, InKeyword, PrivateKeyword, ProtectedKeyword, PublicKeyword, ReadonlyKeyword, OutKeyword, OverrideKeyword, StaticKeyword, Modifier, ModifierLike, AccessibilityModifier, ParameterPropertyModifier, ClassMemberModifier, ModifiersArray, GeneratedIdentifierFlags, Identifier, TransientIdentifier, QualifiedName, EntityName, PropertyName, MemberName, DeclarationName, Declaration, NamedDeclaration, DeclarationStatement, ComputedPropertyName, PrivateIdentifier, Decorator, TypeParameterDeclaration, SignatureDeclarationBase, SignatureDeclaration, CallSignatureDeclaration, ConstructSignatureDeclaration, BindingName, VariableDeclaration, VariableDeclarationList, ParameterDeclaration, BindingElement, PropertySignature, PropertyDeclaration, AutoAccessorPropertyDeclaration, ObjectLiteralElement, ObjectLiteralElementLike, PropertyAssignment, ShorthandPropertyAssignment, SpreadAssignment, VariableLikeDeclaration, ObjectBindingPattern, ArrayBindingPattern, BindingPattern, ArrayBindingElement, FunctionLikeDeclarationBase, FunctionLikeDeclaration, FunctionLike, FunctionDeclaration, MethodSignature, MethodDeclaration, ConstructorDeclaration, SemicolonClassElement, GetAccessorDeclaration, SetAccessorDeclaration, AccessorDeclaration, IndexSignatureDeclaration, ClassStaticBlockDeclaration, TypeNode, KeywordTypeNode, ImportTypeAssertionContainer, ImportTypeNode, ThisTypeNode, FunctionOrConstructorTypeNode, FunctionOrConstructorTypeNodeBase, FunctionTypeNode, ConstructorTypeNode, NodeWithTypeArguments, TypeReferenceType, TypeReferenceNode, TypePredicateNode, TypeQueryNode, TypeLiteralNode, ArrayTypeNode, TupleTypeNode, NamedTupleMember, OptionalTypeNode, RestTypeNode, UnionOrIntersectionTypeNode, UnionTypeNode, IntersectionTypeNode, ConditionalTypeNode, InferTypeNode, ParenthesizedTypeNode, TypeOperatorNode, IndexedAccessTypeNode, MappedTypeNode, LiteralTypeNode, StringLiteral, StringLiteralLike, PropertyNameLiteral, TemplateLiteralTypeNode, TemplateLiteralTypeSpan, Expression, OmittedExpression, PartiallyEmittedExpression, UnaryExpression, IncrementExpression, UpdateExpression, PrefixUnaryOperator, PrefixUnaryExpression, PostfixUnaryOperator, PostfixUnaryExpression, LeftHandSideExpression, MemberExpression, PrimaryExpression, NullLiteral, TrueLiteral, FalseLiteral, BooleanLiteral, ThisExpression, SuperExpression, ImportExpression, DeleteExpression, TypeOfExpression, VoidExpression, AwaitExpression, YieldExpression, SyntheticExpression, ExponentiationOperator, MultiplicativeOperator, MultiplicativeOperatorOrHigher, AdditiveOperator, AdditiveOperatorOrHigher, ShiftOperator, ShiftOperatorOrHigher, RelationalOperator, RelationalOperatorOrHigher, EqualityOperator, EqualityOperatorOrHigher, BitwiseOperator, BitwiseOperatorOrHigher, LogicalOperator, LogicalOperatorOrHigher, CompoundAssignmentOperator, AssignmentOperator, AssignmentOperatorOrHigher, BinaryOperator, LogicalOrCoalescingAssignmentOperator, BinaryOperatorToken, BinaryExpression, AssignmentOperatorToken, AssignmentExpression, ObjectDestructuringAssignment, ArrayDestructuringAssignment, DestructuringAssignment, BindingOrAssignmentElement, ObjectBindingOrAssignmentElement, ArrayBindingOrAssignmentElement, BindingOrAssignmentElementRestIndicator, BindingOrAssignmentElementTarget, ObjectBindingOrAssignmentPattern, ArrayBindingOrAssignmentPattern, AssignmentPattern, BindingOrAssignmentPattern, ConditionalExpression, FunctionBody, ConciseBody, FunctionExpression, ArrowFunction, LiteralLikeNode, TemplateLiteralLikeNode, LiteralExpression, RegularExpressionLiteral, NoSubstitutionTemplateLiteral, TokenFlags, NumericLiteral, BigIntLiteral, LiteralToken, TemplateHead, TemplateMiddle, TemplateTail, PseudoLiteralToken, TemplateLiteralToken, TemplateExpression, TemplateLiteral, TemplateSpan, ParenthesizedExpression, ArrayLiteralExpression, SpreadElement, ObjectLiteralExpressionBase, ObjectLiteralExpression, EntityNameExpression, EntityNameOrEntityNameExpression, AccessExpression, PropertyAccessExpression, PropertyAccessChain, SuperPropertyAccessExpression, PropertyAccessEntityNameExpression, ElementAccessExpression, ElementAccessChain, SuperElementAccessExpression, SuperProperty, CallExpression, CallChain, OptionalChain, SuperCall, ImportCall, ExpressionWithTypeArguments, NewExpression, TaggedTemplateExpression, InstanceofExpression, CallLikeExpression, AsExpression, TypeAssertion, SatisfiesExpression, AssertionExpression, NonNullExpression, NonNullChain, MetaProperty, JsxElement, JsxOpeningLikeElement, JsxAttributeLike, JsxAttributeName, JsxTagNameExpression, JsxTagNamePropertyAccess, JsxAttributes, JsxNamespacedName, JsxOpeningElement, JsxSelfClosingElement, JsxFragment, JsxOpeningFragment, JsxClosingFragment, JsxAttribute, JsxAttributeValue, JsxSpreadAttribute, JsxClosingElement, JsxExpression, JsxText, JsxChild, Statement, NotEmittedStatement, CommaListExpression, EmptyStatement, DebuggerStatement, MissingDeclaration, BlockLike, Block, VariableStatement, ExpressionStatement, IfStatement, IterationStatement, DoStatement, WhileStatement, ForInitializer, ForStatement, ForInOrOfStatement, ForInStatement, ForOfStatement, BreakStatement, ContinueStatement, BreakOrContinueStatement, ReturnStatement, WithStatement, SwitchStatement, CaseBlock, CaseClause, DefaultClause, CaseOrDefaultClause, LabeledStatement, ThrowStatement, TryStatement, CatchClause, ObjectTypeDeclaration, DeclarationWithTypeParameters, DeclarationWithTypeParameterChildren, ClassLikeDeclarationBase, ClassDeclaration, ClassExpression, ClassLikeDeclaration, ClassElement, TypeElement, InterfaceDeclaration, HeritageClause, TypeAliasDeclaration, EnumMember, EnumDeclaration, ModuleName, ModuleBody, ModuleDeclaration, NamespaceBody, NamespaceDeclaration, JSDocNamespaceBody, JSDocNamespaceDeclaration, ModuleBlock, ModuleReference, ImportEqualsDeclaration, ExternalModuleReference, ImportDeclaration, NamedImportBindings, NamedExportBindings, ImportClause, AssertionKey, AssertEntry, AssertClause, ImportAttributeName, ImportAttribute, ImportAttributes, NamespaceImport, NamespaceExport, NamespaceExportDeclaration, ExportDeclaration, NamedImports, NamedExports, NamedImportsOrExports, ImportSpecifier, ExportSpecifier, ImportOrExportSpecifier, TypeOnlyCompatibleAliasDeclaration, TypeOnlyImportDeclaration, TypeOnlyExportDeclaration, TypeOnlyAliasDeclaration, ExportAssignment, FileReference, CheckJsDirective, CommentKind, CommentRange, SynthesizedComment, JSDocTypeExpression, JSDocNameReference, JSDocMemberName, JSDocType, JSDocAllType, JSDocUnknownType, JSDocNonNullableType, JSDocNullableType, JSDocOptionalType, JSDocFunctionType, JSDocVariadicType, JSDocNamepathType, JSDocTypeReferencingNode, JSDoc, JSDocTag, JSDocLink, JSDocLinkCode, JSDocLinkPlain, JSDocComment, JSDocText, JSDocUnknownTag, JSDocAugmentsTag, JSDocImplementsTag, JSDocAuthorTag, JSDocDeprecatedTag, JSDocClassTag, JSDocPublicTag, JSDocPrivateTag, JSDocProtectedTag, JSDocReadonlyTag, JSDocOverrideTag, JSDocEnumTag, JSDocThisTag, JSDocTemplateTag, JSDocSeeTag, JSDocReturnTag, JSDocTypeTag, JSDocTypedefTag, JSDocCallbackTag, JSDocOverloadTag, JSDocThrowsTag, JSDocSignature, JSDocPropertyLikeTag, JSDocPropertyTag, JSDocParameterTag, JSDocTypeLiteral, JSDocSatisfiesTag, FlowFlags, FlowNode, FlowNodeBase, FlowStart, FlowLabel, FlowAssignment, FlowCall, FlowCondition, FlowSwitchClause, FlowArrayMutation, FlowReduceLabel, FlowType, IncompleteType, AmdDependency, SourceFileLike, ResolutionMode, SourceFile, Bundle, InputFiles, UnparsedSource, UnparsedSourceText, UnparsedNode, UnparsedSection, UnparsedPrologue, UnparsedPrepend, UnparsedTextLike, UnparsedSyntheticReference, JsonSourceFile, TsConfigSourceFile, JsonMinusNumericLiteral, JsonObjectExpression, JsonObjectExpressionStatement, ScriptReferenceHost, ParseConfigHost, ResolvedConfigFileName, WriteFileCallbackData, WriteFileCallback, CancellationToken, Program, ResolvedProjectReference, CustomTransformerFactory, CustomTransformer, CustomTransformers, SourceMapSpan, ExitStatus, TypeChecker, NodeBuilderFlags, TypeFormatFlags, SymbolFormatFlags, TypePredicateKind, TypePredicateBase, ThisTypePredicate, IdentifierTypePredicate, AssertsThisTypePredicate, AssertsIdentifierTypePredicate, TypePredicate, SymbolFlags, Symbol, InternalSymbolName, __String, ReadonlyUnderscoreEscapedMap, UnderscoreEscapedMap, SymbolTable, TypeFlags, DestructuringPattern, Type, FreshableType, LiteralType, UniqueESSymbolType, StringLiteralType, NumberLiteralType, BigIntLiteralType, EnumType, ObjectFlags, ObjectType, InterfaceType, BaseType, InterfaceTypeWithDeclaredMembers, TypeReference, DeferredTypeReference, GenericType, ElementFlags, TupleType, TupleTypeReference, UnionOrIntersectionType, UnionType, IntersectionType, StructuredType, EvolvingArrayType, InstantiableType, TypeParameter, IndexedAccessType, TypeVariable, IndexType, ConditionalRoot, ConditionalType, TemplateLiteralType, StringMappingType, SubstitutionType, SignatureKind, Signature, IndexKind, IndexInfo, InferencePriority, FileExtensionInfo, DiagnosticMessage, DiagnosticMessageChain, DiagnosticWithLocation, DiagnosticCategory, ModuleDetectionKind, PluginImport, ProjectReference, CompilerOptionsValue, TypeAcquisition, ImportsNotUsedAsValues, LineAndCharacter, ScriptKind, LanguageVariant, ParsedCommandLine, WatchDirectoryFlags, CreateProgramOptions, ModuleResolutionHost, MinimalResolutionCacheHost, ResolvedModule, ResolvedModuleFull, PackageId, Extension, ResolvedModuleWithFailedLookupLocations, ResolvedTypeReferenceDirective, ResolvedTypeReferenceDirectiveWithFailedLookupLocations, CompilerHost, SourceMapRange, SourceMapSource, EmitFlags, EmitHelperBase, ScopedEmitHelper, UnscopedEmitHelper, EmitHelper, EmitHelperUniqueNameCallback, EmitHint, OuterExpressionKinds, ImmediatelyInvokedFunctionExpression, ImmediatelyInvokedArrowFunction, NodeFactory, CoreTransformationContext, TransformationContext, TransformationResult, TransformerFactory, Transformer, Visitor, NodeVisitor, NodesVisitor, VisitResult, Printer, PrintHandlers, PrinterOptions, GetEffectiveTypeRootsHost, TextChangeRange, SyntaxList, ListFormat, JSDocParsingMode, PseudoBigInt, FileWatcherEventKind, FileWatcherCallback, DirectoryWatcherCallback, BufferEncoding, System, FileWatcher, ErrorCallback, Scanner, ParameterPropertyDeclaration, CreateSourceFileOptions, DiagnosticReporter, ConfigFileDiagnosticsReporter, ParseConfigFileHost, ParsedTsconfig, ExtendedConfigCacheEntry, TypeReferenceDirectiveResolutionCache, ModeAwareCache, PerDirectoryResolutionCache, NonRelativeNameResolutionCache, PerNonRelativeNameCache, ModuleResolutionCache, NonRelativeModuleNameResolutionCache, PackageJsonInfoCache, PerModuleNameCache, ProgramUpdateLevel, FormatDiagnosticsHost, EmitOutput, OutputFile, AffectedFileResult, BuilderProgramHost, BuilderProgram, SemanticDiagnosticsBuilderProgram, EmitAndSemanticDiagnosticsBuilderProgram, ReadBuildProgramHost, IncrementalProgramOptions, WatchStatusReporter, CreateProgram, WatchHost, ProgramHost, WatchCompilerHost, WatchCompilerHostOfFilesAndCompilerOptions, WatchCompilerHostOfConfigFile, Watch, WatchOfConfigFile, WatchOfFilesAndCompilerOptions, BuildOptions, ReportEmitErrorSummary, ReportFileInError, SolutionBuilderHostBase, SolutionBuilderHost, SolutionBuilderWithWatchHost, SolutionBuilder, InvalidatedProjectKind, InvalidatedProjectBase, UpdateOutputFileStampsProject, BuildInvalidedProject, UpdateBundleProject, InvalidatedProject, IScriptSnapshot, PreProcessedFileInfo, HostCancellationToken, InstallPackageOptions, PerformanceEvent, LanguageServiceMode, IncompleteCompletionsCache, LanguageServiceHost, WithMetadata, SemanticClassificationFormat, LanguageService, JsxClosingTagInfo, LinkedEditingInfo, CombinedCodeFixScope, OrganizeImportsArgs, GetCompletionsAtPositionOptions, SignatureHelpItemsOptions, ApplyCodeActionCommandResult, Classifications, ClassifiedSpan, ClassifiedSpan2020, InlayHint, InlayHintDisplayPart, TodoCommentDescriptor, TodoComment, TextChange, FileTextChanges, CodeActionCommand, InstallPackageAction, TextInsertion, DocumentSpan, RenameLocation, ReferenceEntry, ImplementationLocation, HighlightSpanKind, NavigateToItem, EditorOptions, FormatCodeOptions, ReferencedSymbolDefinitionInfo, ReferencedSymbol, ReferencedSymbolEntry, SymbolDisplayPartKind, QuickInfo, RenameInfoOptions, DocCommentTemplateOptions, InteractiveRefactorArguments, CompletionInfoFlags, CompletionEntryDataAutoImport, CompletionEntryDataUnresolved, CompletionEntryDataResolved, CompletionEntryData, OutliningSpanKind, OutputFileType, EndOfLineState, TokenClass, ClassificationResult, ClassificationInfo, Classifier, ScriptElementKind, ScriptElementKindModifier, ClassificationTypeNames, InlayHintsContext, ExportMapInfoKey, DocumentHighlights, DocumentRegistry, DocumentRegistryBucketKey, TranspileOptions, TranspileOutput } from "typescript";
;

import { SyntaxKind, PunctuationSyntaxKind, KeywordSyntaxKind, ModifierSyntaxKind, KeywordTypeSyntaxKind, NodeFlags, ModifierFlags, Node, HasDecorators, HasModifiers, NodeArray, Token, EndOfFileToken, PunctuationToken, DotDotDotToken, QuestionToken, ExclamationToken, ColonToken, EqualsToken, AsteriskToken, EqualsGreaterThanToken, PlusToken, MinusToken, QuestionDotToken, KeywordToken, AssertsKeyword, AwaitKeyword, ModifierToken, ReadonlyKeyword, Modifier, ModifierLike, GeneratedIdentifierFlags, Identifier, QualifiedName, EntityName, PropertyName, MemberName, ComputedPropertyName, PrivateIdentifier, Decorator, TypeParameterDeclaration, CallSignatureDeclaration, ConstructSignatureDeclaration, BindingName, VariableDeclaration, VariableDeclarationList, ParameterDeclaration, BindingElement, PropertySignature, PropertyDeclaration, ObjectLiteralElementLike, PropertyAssignment, ShorthandPropertyAssignment, SpreadAssignment, ObjectBindingPattern, ArrayBindingPattern, ArrayBindingElement, FunctionDeclaration, MethodSignature, MethodDeclaration, ConstructorDeclaration, SemicolonClassElement, GetAccessorDeclaration, SetAccessorDeclaration, AccessorDeclaration, IndexSignatureDeclaration, ClassStaticBlockDeclaration, TypeNode, KeywordTypeNode, ImportTypeAssertionContainer, ImportTypeNode, ThisTypeNode, FunctionTypeNode, ConstructorTypeNode, TypeReferenceNode, TypePredicateNode, TypeQueryNode, TypeLiteralNode, ArrayTypeNode, TupleTypeNode, NamedTupleMember, OptionalTypeNode, RestTypeNode, UnionTypeNode, IntersectionTypeNode, ConditionalTypeNode, InferTypeNode, ParenthesizedTypeNode, TypeOperatorNode, IndexedAccessTypeNode, MappedTypeNode, LiteralTypeNode, StringLiteral, PropertyNameLiteral, TemplateLiteralTypeNode, TemplateLiteralTypeSpan, Expression, OmittedExpression, PartiallyEmittedExpression, PrefixUnaryOperator, PrefixUnaryExpression, PostfixUnaryOperator, PostfixUnaryExpression, NullLiteral, TrueLiteral, FalseLiteral, ThisExpression, SuperExpression, DeleteExpression, TypeOfExpression, VoidExpression, AwaitExpression, YieldExpression, BinaryOperator, BinaryOperatorToken, BinaryExpression, AssignmentExpression, DestructuringAssignment, ConditionalExpression, ConciseBody, FunctionExpression, ArrowFunction, RegularExpressionLiteral, NoSubstitutionTemplateLiteral, TokenFlags, NumericLiteral, BigIntLiteral, TemplateHead, TemplateMiddle, TemplateTail, TemplateExpression, TemplateLiteral, TemplateSpan, ParenthesizedExpression, ArrayLiteralExpression, SpreadElement, ObjectLiteralExpression, PropertyAccessExpression, PropertyAccessChain, ElementAccessExpression, ElementAccessChain, CallExpression, CallChain, ExpressionWithTypeArguments, NewExpression, TaggedTemplateExpression, AsExpression, TypeAssertion, SatisfiesExpression, NonNullExpression, NonNullChain, MetaProperty, JsxElement, JsxAttributeLike, JsxAttributeName, JsxTagNameExpression, JsxAttributes, JsxNamespacedName, JsxOpeningElement, JsxSelfClosingElement, JsxFragment, JsxOpeningFragment, JsxClosingFragment, JsxAttribute, JsxAttributeValue, JsxSpreadAttribute, JsxClosingElement, JsxExpression, JsxText, JsxChild, Statement, NotEmittedStatement, CommaListExpression, EmptyStatement, DebuggerStatement, Block, VariableStatement, ExpressionStatement, IfStatement, DoStatement, WhileStatement, ForInitializer, ForStatement, ForInStatement, ForOfStatement, BreakStatement, ContinueStatement, ReturnStatement, WithStatement, SwitchStatement, CaseBlock, CaseClause, DefaultClause, CaseOrDefaultClause, LabeledStatement, ThrowStatement, TryStatement, CatchClause, ClassDeclaration, ClassExpression, ClassElement, TypeElement, InterfaceDeclaration, HeritageClause, TypeAliasDeclaration, EnumMember, EnumDeclaration, ModuleName, ModuleBody, ModuleDeclaration, JSDocNamespaceDeclaration, ModuleBlock, ModuleReference, ImportEqualsDeclaration, ExternalModuleReference, ImportDeclaration, NamedImportBindings, NamedExportBindings, ImportClause, AssertionKey, AssertEntry, AssertClause, ImportAttributeName, ImportAttribute, ImportAttributes, NamespaceImport, NamespaceExport, NamespaceExportDeclaration, ExportDeclaration, NamedImports, NamedExports, ImportSpecifier, ExportSpecifier, ExportAssignment, FileReference, JSDocTypeExpression, JSDocNameReference, JSDocMemberName, JSDocAllType, JSDocUnknownType, JSDocNonNullableType, JSDocNullableType, JSDocOptionalType, JSDocFunctionType, JSDocVariadicType, JSDocNamepathType, JSDoc, JSDocTag, JSDocLink, JSDocLinkCode, JSDocLinkPlain, JSDocComment, JSDocText, JSDocUnknownTag, JSDocAugmentsTag, JSDocImplementsTag, JSDocAuthorTag, JSDocDeprecatedTag, JSDocClassTag, JSDocPublicTag, JSDocPrivateTag, JSDocProtectedTag, JSDocReadonlyTag, JSDocOverrideTag, JSDocEnumTag, JSDocThisTag, JSDocTemplateTag, JSDocSeeTag, JSDocReturnTag, JSDocTypeTag, JSDocTypedefTag, JSDocCallbackTag, JSDocOverloadTag, JSDocThrowsTag, JSDocSignature, JSDocPropertyLikeTag, JSDocPropertyTag, JSDocParameterTag, JSDocTypeLiteral, JSDocSatisfiesTag, SourceFile, Bundle, InputFiles, UnparsedSource, OuterExpressionKinds, ImmediatelyInvokedArrowFunction, PseudoBigInt } from "typescript";
